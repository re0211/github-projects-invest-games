...
*最后更新：2026-09-23（第十八辑：+3 条决策原则 → 共 **54** 条；新增 harness tax 探针）*
*来源索引：index.html（**1104** 项，第十八辑新增 10 个已登记：第二十四版增补）+ csdn-social-summary.md（**约 567 条**经验帖，第十八辑新增约 44 条）+ mistakes/（错误记忆 **19** 条，+M-0019）+ agent-house-rules.md（**39** 条房规，+#37 #38 #39）+ 工具 `_tools/harness_tax_probe.py`*
