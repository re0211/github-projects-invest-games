...
*最后更新：2026-09-20（第十一辑）*
*来源索引：index.html（**1054** 项，第十一辑新增 5 个已登记：第十六版增补）+ csdn-social-summary.md（**约 305 条**经验帖，第十一辑新增 29 条）+ mistakes/（错误记忆 **9** 条）+ agent-house-rules.md（**23** 条房规）+ refs/renpy-android-packager-skill（已克隆实测）+ refs/renpy-mcp（已克隆实测，结论：不采用）*
