...
GitHub Repository API 与 Search API，抓取时间 **2026-09-08**（UTC+8）。共 **398** 个项目，星级、最近更新时间、License、归档状态均为逐项实测值。
...
正文每张卡片底部标注最近更新时间、License 与信源编号，编号可点击跳转至页脚完整信源清单（共 398 项，全部可追溯）。信源编号按正文出现顺序编排，正文条目与页脚清单一一对应。
